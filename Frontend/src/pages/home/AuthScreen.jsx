...
function AuthScreen() {
  ...
  return (
    <div className='hero-bg relative'>
        ...
        <div className='text-white flex flex-col justify-center text-center py-40 max-w-6xl mx-auto'>
          <h1 className='text-4xl md:text-6xl font-bold mb-4'>Unlimited movies, TV shows, and more</h1>
          <p className='text-lg mb-4'>Watch anywhere. cancel anytime.</p>
          <p className='mb-4'>Ready to watch? Enter your email to create or restart your membership.</p>

          <form action="" className='flex flex-col md:flex-row gap-4 w-1/2 mx-auto'>
          <input 
          type="email"
          placeholder='Email Address' 
          className='p-2 rounded4 flex-1 bg-black/80 border-gray-700'
          value={email}
      ...
      <div className='py-10 bg-black text-white'>
        <div className='flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col px-4 md:px-2'>
          ...
          <h2 className='text-4xl md:text-5xl fint font-extrabold mb-4'>Enjoy on your TV</h2>
      ...
      <div className='py-10 bg-black text-white'>
        <div className='flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col-reverse px-4 md:px-2 '>
          ...
          <div className="flex-1 text-center">
            <h2 className='text-4xl md:text5xl font-extrabold mb-4 text-balance'>Download your shows to watch offline</h2>
